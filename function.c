...
/* -------------------------------*/
/** 
 * @Synopsis  display_mat 
 * Display square matrix
 * 
 * @Param a square matrix pointer 
 * @Param n_data square matrix size
 */
/* ---------------------------------*/
...
/* -------------------------------*/
/** 
 * @Synopsis  display_vec 
 * Display vector
 * 
 * @Param a vector pointer
 * @Param n_data vector size
 */
/* ---------------------------------*/
...
/** 
 * @Synopsis  list_vec_i 
 * Display int type vector for debug mode
 * 
 * @Param a vector pointer
 * @Param n_data sizeof vector
 */
/* ---------------------------------*/
...
/** 
 * @Synopsis  list_vec_d 
 * Display double type vector for debug mode
 * 
 * @Param a vector pointer
 * @Param n_data sizeof vector
 */
...
/** 
 * @Synopsis  bxcreate 
 * creat an right-side vector "b" and "x"vector"
 * 
 * @Param a matrix pointer
 * @Param b b vector pointer 
 * @Param x x vector pointer
 * @Param n_data sizeof matrix
 */
/* ---------------------------------*/
void
...
/** 
 * @Synopsis  CSR 
 * real time fransfor to CSR format
 * 
 * @Param a matrix pointer
 * @Param val val vector pointer for CSR 
 * @Param col col vector pointer for CSR
 * @Param ptr ptr vector pointer for CSR
 * @Param n_data sizeof matrix
 * @Param m number of non zero value in matrix
 */
  /* ---------------------------------*/
CSR(const double *a,
    double *val,
...
/** 
 * @Synopsis  usage 
 *check usage error when try to open matrix file 
 * @Param a matrix pointer
 * @Param b b vector pointer
 * @Param x x vector pointer 
 * @Param ndata sizeof matrix
 * @Param m number of non zero value in matrix 
 */
  /* ---------------------------------*/
void 
 ...
 * @Param a matrix 
 * @Param ndata sizeof matrix
 * @Param m number of nun zero value in matrix
 */
/* ---------------------------------*/
...
void getvector(const char *file, double *v, int ndata)
{
  ...
  /** 
   * @Synopsis  gethead 
   * get head part of matrix file
   * 
   * @Param file1 file1name
   * @Param file2 file2name
   * @Param file3 file3name
   * @Param N sizeof matrix
   * @Param NZ non zeor part of sizeofo matrix 
   */
  /* ---------------------------------*/
void gethead(const char *file1, const char *file2, const char *file3, int *N, int *NZ)
{
  ...
  {
    printf("error NZ was not same in 3files\n");
    exit(0);
  }
 ...
 * @Param file2 file2name
 * @Param file3 file3name
 * @Param col col vecotor
 * @Param ptr ptr vector
 * @Param val val vector
 * @Param b b vector
 * @Param x xvector
 * @Param N sizeof matri
 * @Param NZ nonpart of sizeof matrix
 */
    /* ---------------------------------*/
